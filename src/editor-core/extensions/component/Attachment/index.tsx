...
import { CarouselViewIcon, DeleteLineIcon, DownloadLineIcon, EditLineIcon, ScrollToBottomLineIcon } from "../../../../components/Icons";
...
const AttachmentViewWrapper: React.FC<NodeViewProps & EditorFnProps & { attachmentType?: 'icon' | 'block' }> = ({
  ...
  const handleShowPopover = () => {
    openFromElement(attachmentContentRef.current)
  }
